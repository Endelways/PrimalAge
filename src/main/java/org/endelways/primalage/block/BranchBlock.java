...
public class BranchBlock extends PrimalageModElements.ModElement {
	@ObjectHolder("primalage:branch")
	public static final Block block = null;
	public BranchBlock(PrimalageModElements instance) {
		super(instance, 20);
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.PLANT).hardnessAndResistance(0f, 0f).setLightLevel(s -> 0)
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			return VoxelShapes.create(0.075D, 0D, 0.075D, 0.925D, 0.2D, 0.925D).withOffset(offset.x, offset.y, offset.z);
		}
